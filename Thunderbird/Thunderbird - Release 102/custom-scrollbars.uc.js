...
/* ******************************************************************************************** */
  ...
  if(custom_scrollbar_arrows === true && custom_scrollbar_arrows_version === 1)
	...
	custom_scrollbar_arrows_code=`
		...
		scrollbar[orient="vertical"] > scrollbarbutton[type="decrement"]:hover {
		  background-image: url("${ProfilePathChrome}icons/up1.svg") !important;
		}
		scrollbar[orient="vertical"] > scrollbarbutton[type="increment"]:hover {
		  background-image: url("${ProfilePathChrome}icons/down1.svg") !important;
		}
		scrollbar[orient="horizontal"] > scrollbarbutton[type="decrement"]:hover {
		  background-image: url("${ProfilePathChrome}icons/left1.svg") !important;
		}
		scrollbar[orient="horizontal"] > scrollbarbutton[type="increment"]:hover {
		  background-image: url("${ProfilePathChrome}icons/right1.svg") !important;
		}
	`;
