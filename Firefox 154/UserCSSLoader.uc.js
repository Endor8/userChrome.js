 ...
 * 2026-08-21 angepasst an Firefox 153esr mit Hilfe von KI:
 *   Firefox setzt nicht mehr "checked=true" und "checked=false" wie dieses Skript,
 *    sondern nur noch "checked" oder keine Attribut. Dadurch bekamen auch Menüeinträge
 *    mit "checked=false" ein Checkmark, weil auch hier "checked" enthalten war.
 *    Jetzt setzt das Skript "checked=true" bzw. entfernt das Attribut.
 */
...
window.UCL = {
	...
	if (!event.ctrlKey) {
		this.css.disabled = !this.css.disabled;
		if (!this.css.disabled) {
