...
(() => {
  ...
  if (
    ...
    CustomizableUI.createWidget({
      ...
      onBuild(aDoc) {
        let CustomHint = {
          ...aDoc.documentGlobal.ConfirmationHint,
