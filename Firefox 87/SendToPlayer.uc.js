...
// @include        main
// @charset        UTF-8
// @version        0.9.1 Youtubeの埋め込みリンクにも対応
// @version        0.9 プレーヤーに送るYoutubeリンクに余計なパラメータを付加しないように、軽微な修正
...
(function() {
	...
	function initOverlay() {
		...
		var mi = cm.insertBefore(document.createXULElement('menuitem'), cm.firstChild);
