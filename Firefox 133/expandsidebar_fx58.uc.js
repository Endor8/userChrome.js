...
// @version        2022/08/26 09:45 Bug 1695435 - Remove @@hasInstance for IDL interfaces in chrome context
...
// ==/UserScript==
// @version        2012/08/04 09:00 Privates browsen Unterstützung
// @version        2012/08/04 09:00 Verwenden von „Eingeklappt“ statt „Ausgeblendet“.
// @version        2012/02/08 14:00 splitter width in full screen
// @version        2011/05/26 12:00 In 5.0a2 bei Maushover, wurde das Mouseover-Ereignis bei zu hoher Bewegungsgeschwindigkeit nicht ausgelöst. Hat die Empfindlichkeit abgenommen?
// @version        2011/03/24 12:00 Separate Dragover-Verzögerungseinstellung
// @version        2010/10/30 18:00 http://hg.mozilla.org/mozilla-central/pushloghtml?fromchange=84baf90b040c&tochange=16eac4b8b8e0
// @version        2010/10/09 18:00 Windows 7 Aero
// @version        2009/06/06 20:00 Weil es sich durch Überziehen schließt
// @version        2009/05/24 18:00 Chrom-Check-Änderung
// @version        2009/04/30 18:00 Timer wird jetzt gelöscht, wenn die Seitenleiste geöffnet oder geschlossen wird.
// @version        2009/04/28 00:00 Lastreduzierung
// @version        2009/04/23 00:00 _KEEP_SIZES funktionierte nicht mehr
// @version        2009/04/22 12:00 Ließ sich wegen Überziehen nicht öffnen
// @version        2009/04/15 21:00 Seitenleiste öffnete sich bei Maus Berührung nicht, und blieb hängen.
// @version        2009/04/15 19:00 Kleinere Fehlerbehebungen
// @version        2009/04/15 02:00 _CLOSEWHENGOOUT funktionierte nicht mehr
// @version        2009/04/14 22:00 fx2 Code entfernt
...
*/
    ...
    //Fokussierende Aktion der Seitenleisten ausführen
    //
    ...
    //Seitenleiste beim Start geschlossen halten?
...
*/
  ...
  //Trennen, um die Last zu reduzieren
  ...
  _openSidebar: function(_command, _forceOpen){
    ...
    //Flag, ob Mouseout sofort nach dem Öffnen behandelt werden soll =true
    this._opend = true;
    if(this._mouseoutTimer)
      clearTimeout(this._mouseoutTimer);
      //Auf „false“ setzen, damit Mouseout nach Ablauf von 200ms nach dem Öffnen verarbeitet werden kann
  ...
  _checkWindowSideOrNot: function(event){ 
    ...
    if (sidebar_box.getBoundingClientRect().width == 0) {
      sidebar_box.style.setProperty('width', this._defaultWidth + "px", "");//Standardbreite der Seitenleiste
      //this._sidebar.style.setProperty('width', this._defaultWidth - 1 + "px", "");//Standardbreite der Seitenleiste
    }
