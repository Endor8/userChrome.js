...
function MultiRowTabLiteforFx() {
    ...
    #toolbar-menubar:not([inactive]) ~ #nav-bar .titlebar-buttonbox-container,
    :root[inFullscreen="true"] #fullscr-toggler:not([hidden]) ~ #titlebar > #TabsToolbar > #window-controls { display: none !important; }
    ...
    /* Ich habe versucht, die Tableiste im Vollbildmodus auszublenden und anzuzeigen, indem ich die 
	   Maus über den oberen und unteren Bildschirmrand bewegte. Wenn Sie mit der Maus über den oberen 
	   Bildschirmrand fahren, wird die Tableiste zusammen mit der Symbolleiste angezeigt.
    ...
    /* Da das Theme nicht funktioniert, habe ich den CSS-Code, der benötigt wird, um es zum Laufen zu bringen,
