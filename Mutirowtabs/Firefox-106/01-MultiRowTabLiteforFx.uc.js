...
function MultiRowTabLiteforFx() {
    ...
    /* ↓ Wenn Sie die Auskommentierung auf der linken und rechten Seite des unten stehenden CSS-Codes entfernen,  
		 ...
		 Fensters ausgeblendet wird. */    /* :root:not([sizemode="normal"]) hbox.titlebar-spacer[type="pre-tabs"] { display: block !important; } */

    /* ↓ Wenn Sie die Auskommentierung links und rechts vom unten stehenden CSS-Code entfernen und den CSS-Code aktivieren,    
         können Sie den linken und rechten Ziehbereiche einblenden, der im Vollbildmodus ausgeblendet wird. */    /* :root[inFullscreen] .titlebar-spacer { display: block !important; } */
