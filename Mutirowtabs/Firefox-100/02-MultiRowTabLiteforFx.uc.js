...
function MultiRowTabLiteforFx() {
    ...
    :root:not([tabsintitlebar]) #TabsToolbar[inFullscreen] > .titlebar-buttonbox-container,
    :root[tabsintitlebar] #TabsToolbar > .titlebar-buttonbox-container { display: block !important; margin: 0 !important; }
    ...
    :root:not([tabsintitlebar]) #TabsToolbar[inFullscreen] .titlebar-button { height: calc(8px + var(--tab-min-height)); }
    ...
    .tabbrowser-tab,:root[tabsintitlebar] #TabsToolbar .titlebar-button,
