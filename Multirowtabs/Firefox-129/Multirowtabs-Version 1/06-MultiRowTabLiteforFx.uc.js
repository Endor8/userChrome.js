...
function MultiRowTabLiteforFx() {
    ...
    #tabbrowser-arrowscrollbox::part(scrollbox) {
      max-height: calc(var(--tab-min-height) * 3); /* Anzahl der Tabzeilen(Standard = 3 Zeilen) */
    }
 ...
 ↓Es ist auskommentiert. Wenn Sie es also durch ein Symbol wie eine Stecknadel 📍 ersetzen möchten, entfernen Sie es bitte. */
    ...
    */
    ...
    /* Blenden Sie im Vollbildmodus die Tab-Leiste aus und zeigen Sie sie mit der Symbolleiste an, indem Sie den Mauszeiger über den oberen oder unteren Bildschirmrand bewegen. */
    body {
      & > #fullscr-toggler[hidden] + tabbox,
      :root[inFullscreen] & > tabbox:hover {
        border-top: .5px solid var(--chrome-content-separator-color);
      }
    ...
    /* Leerraum um die Tabs auf 0 ändern, um der Dichte der Benutzeroberfläche zu entsprechen. */
    ...
    /* Leerraum um den Tab auf 0 ändern, um den Farbbalken darüber auszublenden. Damit er sichtbar wird, Wert erhöhen bis es passt. */
    ...
    document.getElementById("navigator-toolbox").prepend(
      document.adoptNode(document.getElementById("toolbar-menubar")),
      document.getElementById("nav-bar"),
      document.getElementById("PersonalToolbar"),
    );

    document.getElementById("nav-bar").appendChild(
      document.adoptNode(document.querySelector("#TabsToolbar > .titlebar-buttonbox-container"))
    );
