...
(function() {
  ...
  // ■■ urlobj-Array ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
  urlobj = {
    MO_Doppelklick:           {url:"https://www.msn.com/de-de/wetter/vorhersage/in-Braunschweig",width:700,height:640},
    MO_Rechtsklick:           {url:"http://www.wetter.net/1370/Braunschweig",width:850,height:630},
	...
	DED_Regenradar:           {url:"https://www.wetterkontor.de/de/radar.asp?p=1",width:532,height:635},
    DED_RegenradarVorhersage: {url:"https://www.wetterkontor.de/de/radar/radar-vorhersage.asp?p=1",width:528,height:635},
    ...
    DE_RegenradarAktuell:     {url:"https://www.niederschlagsradar.de/de-de",width:770,height:700},
    ...
    EU_Unwetterwarnung:       {url:"https://www.wetter.net/grosswetterlagenkarte",width:950,height:750},
    EU_RegenradarAktuell:     {url:"https://www.niederschlagsradar.de/de-de/continent/eu",width:770,height:700},
    ...
    RE_Unwetterwarnung:       {url:"https://www.wetterkontor.de/warnungen/wetterwarnungen-niedersachsen-bremen.asp",width:850,height:560},
    RE_RegenradarAktuell:     {url:"https://www.wetterkontor.de/de/radar/radar-nordwest.asp",width:568,height:530},
  ...
  setInterval(function() {
    ...
    // ESC-Taste zum Schließen des Wetterfuchs-Panels
  document.addEventListener('keydown', function(event) {
    if (event.key === 'Escape' || event.keyCode === 27) {
      const panel = document.getElementById('wetterfuchs-panel');
