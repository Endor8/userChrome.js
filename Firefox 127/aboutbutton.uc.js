   ...
   menuitem = document.createXULElement('menuitem');
   menuitem.setAttribute('label', "about:Dialog");
   menuitem.setAttribute('tooltiptext', "about:Dialog öffnen");
   menuitem.setAttribute('accesskey', "D");
   menuitem.setAttribute('oncommand', 'openTrustedLinkIn("chrome://browser/content/aboutDialog.xhtml", "tab");');
   menupopup.appendChild(menuitem);   
   ...
   menuitem.setAttribute('accesskey', "l");
   menuitem.setAttribute('oncommand', 'openTrustedLinkIn("about:logging", "tab");');
   menupopup.appendChild(menuitem); 
   ...
   menuitem.setAttribute('oncommand', 'openTrustedLinkIn("about:profiling", "tab");');
   menupopup.appendChild(menuitem);
   ...
   menuitem.setAttribute('accesskey', "t");
   menuitem.setAttribute('oncommand', 'openTrustedLinkIn("about:translations", "tab");');
   menupopup.appendChild(menuitem);    
