   ...
   menuitem.addEventListener('click', event => {
					if (event.button == 0) {  window.open('chrome://browser/content/preferences/dialogs/siteDataSettings.xhtml', 'Browser:Cookies', 'chrome,resizable=yes,width=600,height=750');
					}
   });
   menupopup.appendChild(menuitem);
   ...
   menuitem.addEventListener('click', event => {
					if (event.button == 0) { document.getElementById("menuitem_storage").click
					();
					}
   });					
   menupopup.appendChild(menuitem);
   ...
   menuitem.addEventListener('click', event => {
					if (event.button == 0) {  window.open( 'chrome://browser/content/preferences/permissions.xhtml', 'Browser:permissions', 'chrome,resizable=yes');
					}
   });
   menupopup.appendChild(menuitem);
   ...
   menuitem.addEventListener('click', event => {
					if (event.button == 0) {  window.open( 'chrome://pippki/content/certManager.xhtml', 'mozilla:certmanager', 'chrome,resizable=yes,all,width=830,height=400');
   					}
   });				
   menupopup.appendChild(menuitem);
   ...
   menuitem.addEventListener('click', event => {
					if (event.button == 0) {  window.open('chrome://browser/content/sanitize.xhtml', 'Toolkit:SanitizeDialog', 'chrome,resizable=yes');
   					}
   });
   menupopup.appendChild(menuitem);
   ...
   menuitem.addEventListener('click', event => {
					if (event.button == 0) {  window.open('chrome://mozapps/content/update/history.xhtml', 'Update:History','chrome,resizable=yes');
   					}
   });					
   menupopup.appendChild(menuitem);
